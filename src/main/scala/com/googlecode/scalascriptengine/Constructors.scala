...
class Constructors[T](clz: Class[T]) {
  ...
  def newInstance[P1, P2, P3](
    p1: P1,
    p2: P2,
    p3: P3
  )(implicit p1m: ClassTag[P1], p2m: ClassTag[P2], p3m: ClassTag[P3]): T = {
  ...
  def newInstance[P1, P2, P3, P4](
    p1: P1,
    p2: P2,
    p3: P3,
    p4: P4
  )(implicit p1m: ClassTag[P1], p2m: ClassTag[P2], p3m: ClassTag[P3], p4m: ClassTag[P4]): T = {
  ...
  /**
	 ...
	 */
  def constructorWith3Args[P1, P2, P3](
    implicit p1m: ClassTag[P1],
    p2m: ClassTag[P2],
    p3m: ClassTag[P3]
  ): (P1, P2, P3) => T = {
    val c = clz.getConstructor(p1m.runtimeClass, p2m.runtimeClass, p3m.runtimeClass)
  ...
  /**
	 * returns a function that can be used to instantiate the class using 3 arg constructor
	 */
  def constructorWith4Args[P1, P2, P3, P4](
    implicit p1m: ClassTag[P1],
    p2m: ClassTag[P2],
    p3m: ClassTag[P3],
    p4m: ClassTag[P4]
